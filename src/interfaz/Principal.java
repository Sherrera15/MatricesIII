...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Operaciones MatricesIII");
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 50, 350, 60));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 120, 480, 60));

        tblTablaResultado.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 200, 360, 210));
        ...
        jPanel1.add(cmbOperaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 280, -1, -1));

        tblTablaInicial.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 360, 210));

        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Resultado"));
    ...
    private void cmdCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCrearActionPerformed
        ...
        if (txtNumerodeFilas.getText().trim().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "El No. Filas y el No. Columnas deben ser impares");
                ...
                if (nc <= 11 || nf <= 11) {
                    JOptionPane.showMessageDialog(this, "El número que digitó es aceptable");
