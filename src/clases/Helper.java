...
public class Helper {
    ...
    public static String recorridoUno(JTable tabla) {
        ...
        aux = aux + Helper.recorridoHaciaAbajo(m, nc - 1, 0 + 1, nc / 2);
        aux = aux + Helper.recorridoHaciaIzquierda(m, nc / 2, nc - 2, 0);
        aux = aux + Helper.recorridoHaciaAbajo(m, 0, nf / 2 + 1, nf - 1);
        aux = aux + Helper.recorridoHaciaDerecha(m, nf - 1, 1 - 0, nc - 1);
    ...
    public static String recorridoDos(JTable tabla) {
        ...
        aux = aux + Helper.recorridoHaciaDerecha(m, 0, 0 + 1, nc / 2);
